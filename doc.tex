...
Given the material and the wavelength, we can investigate along which plane a crystal was cut.
These diamond/zincblende crystals must be cut along $(1,0,0)$, $(1,1,0)$ or $(1,1,1)$, of which the $(h,k,l)$-vectors then are multiples.
...
The obvious best fit is the $(1,0,0)$-plane.
