...
The peaks were thereafter manually detected by searching for distinct local maxima. The first maximum of the plots - with a broader peak - come from the bremsstrahlung and do not concern this experiment. These peaks are therefore omitted from the tables of identified peaks.
