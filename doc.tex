...
\end{align}
Which of these angles are allowed depend on the structure factor of the sample.
For InP the structure factor is always nonzero along thing plane - $h,k,l$ always have the same parity.
